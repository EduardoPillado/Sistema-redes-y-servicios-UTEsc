...
<head>
    ...
    <title>Editar tipo de ruta</title>
</head>
<body>
...
<div class="flex items-center justify-center min-h-screen bg-gray-100">
    ...
    <br><br>
    <form action="{{ route('tipoRed.actualizar', $datosTipoRed->pkTipoRed) }}" method="post">
        @csrf
        @method('put')
        <label for="nombre">Nombre del tipo de ruta</label>
        <input type="text" name="nombre" id="nombre" value="{{$datosTipoRed->nombre}}" required 
