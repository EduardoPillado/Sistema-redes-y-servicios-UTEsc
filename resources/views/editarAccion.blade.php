...
<div class="flex items-center justify-center min-h-screen bg-gray-100">
    ...
    >Editar Acción</h2>
    <br><br>
    <form action="{{ route('accion.actualizar', $datosAccion->pkAccion) }}" method="post">
        @csrf
        @method('put')
        <label for="nombreAccion">Nombre de la acción</label>
        <input type="text" name="nombreAccion" id="nombreAccion" value="{{$datosAccion->nombreAccion}}" required 
