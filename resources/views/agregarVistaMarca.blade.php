        ...
        <div class="relative flex flex-col m-6 space-y-8 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0">
            ...
            <div class="flex flex-col justify-center p-8 md:p-14">
                ...
                <form action="{{ route('marca.insertar') }}" method="post">
                    ...
                    <h2 class="mb-3 text-4xl font-bold">Agregar marca</h2>
                    <div class="py-4">
                        <label class="mb-2 text-md" for="nombre">Nombre de la marca</label>
                ...
                <div class="mt-10">
                    <h2 class="mb-3 text-4xl font-bold">Marcas registradas</h2>

                    <table id="tabla-marcas" class="w-full border-4 border-gray-300 table-auto" class="display nowrap" width="100%">
