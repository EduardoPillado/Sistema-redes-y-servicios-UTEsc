...
<head>
    ...
    <title>Editar tipo de área</title>
</head>
<body>
...
<div class="flex items-center justify-center min-h-screen bg-gray-100">
    ...
    >Editar Tipo Área</h2>
    <br><br>
    <form action="{{ route('tipoArea.actualizar', $datosTipoArea->pkTipoArea) }}" method="post">
        @csrf
        @method('put')
        <label for="nombreTipoArea">Nombre del tipo de área</label>
        <input type="text" name="nombreTipoArea" id="nombreTipoArea" value="{{$datosTipoArea->nombreTipoArea}}" required 
