...
<body>
    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        ...
        <div class="relative flex flex-col m-6 space-y-8 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0">
            ...
            <div class="flex flex-col justify-center p-8 md:p-14">
                ...
                <form class="formulario123" action="{{ route('tipoDispositivo.insertar')}}" enctype="multipart/form-data" method="post">
                    @csrf

                    <h2 class="mb-3 text-4xl font-bold">Agregar tipo de dispositivo</h2>
                    <div class="py-4">
                        <label class="mb-2 text-md" for="">Nombre del tipo dispositivo</label>
                        <input type="text" name="nombreTipoDispositivo" class="w-full pr-10 pl-10 p-2 border border-gray-300 rounded-md placeholder:font-light placeholder:text-gray-500" required>
                    </div>
                ...
                <div class="mt-10">
                    <h2 class="mb-3 text-4xl font-bold">Tipos de dispositivos registrados</h2>

                    <table id="tabla-tipoDispositivo" class="w-full border-4 border-gray-300 table-auto" class="display nowrap" width="100%">
                        <thead class="border-4 bg-gray-200 border-gray-300 text-center">
                            <tr class="h-24">
                                <th class="linea-izquierda border-gray-300">Nombre tipo de dispositivo</th>
                        ...
                        @foreach ( $datosTipoDispositivo as $dato )
                            <tr class="h-20 text text-center linea-abajo border-gray-300">
                                <td class="linea-izquierda border-gray-300">{{ $dato->nombreTipoDispositivo }}</td>
                                <td class="linea-izquierda border-gray-300">
                                    <div>
                                        <div>
                                            <a href="{{route('tipoDispositivo.mostrarPorId', $dato->pkTipoDispositivo)}}">
                                        ...
                                        <div>
                                            <a href="{{route('tipoDispositivo.baja', $dato->pkTipoDispositivo)}}">
                                                <svg class="w-[2rem] h-[2rem]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#tabla-tipoDispositivo').DataTable({
                "language": {
                "search": "Buscar:",
